...
int matrix[100][100],visited[100];int stack[100];
int count=0;int opcount=0;int dfscount=0;int iscylic=0;int top=-1;
...
void reset(int n){
    ...
    count=0;opcount=0;iscylic=0;dfscount=0;top=-1;
